...
files <- list.files(file.path(here::here("plots")))
plts <- map(file.path(here::here("plots", find_files(files, ".rds$"))), readRDS)
names(plts) <- gsub(".rds", "", find_files(files, ".rds$"))

# observational -----------------------------------------------------------

leg <- g_legend(plts$bias_binary_fo_0_100)
leg$vp$x <- unit(.9, 'npc')
leg$vp$y <- unit(.875, 'npc')

png(here::here("plots", "bias_binary_obs.png"), width = 12, 
...
arrangeGrob(
  ...
  plts$bias_binary_fo_0_100 + theme(legend.position = "none"), 
  textGrob("Scenario 1", 
           rot = -90, 
           gp = gpar(fontsize = 9, 
                     fontface = "italic")),
  ...
  plts$bias_binary_fo_4_0 + theme(legend.position = "none"),
  textGrob("Scenario 2", 
           rot = -90, 
           gp = gpar(fontsize = 9, 
                     fontface = "italic")),
...
arrangeGrob(
  ...
  plts$mse_binary_fo_0_100 + theme(legend.position = "none"), 
  textGrob("Scenario 1", 
           rot = -90, 
           gp = gpar(fontsize = 9, 
                     fontface = "italic")),
  plts$mse_binary_f2o_4_0 + theme(legend.position = "none"), 
  plts$mse_binary_fo_4_0 + theme(legend.position = "none"),
  textGrob("Scenario 2", 
           rot = -90, 
           gp = gpar(fontsize = 9, 
                     fontface = "italic")),
...
# 0_100
leg <- g_legend(plts$bias_binary_ao_0_100)
leg$vp$x <- unit(.9, 'npc')
leg$vp$y <- unit(.9, 'npc')
...
arrangeGrob(
  ...
  plts$bias_binary_fr_0_100 + theme(legend.position = "none"), 
